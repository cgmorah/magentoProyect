...
namespace Rokanthemes\Onsaleproduct\Block;
...
class Onsaleproduct extends \Magento\Catalog\Block\Product\AbstractProduct {
	...
	{
		$path = 'onsaleproduct/onsaleproduct_config/' . $att;
