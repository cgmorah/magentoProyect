...
namespace Rokanthemes\Preorderproduct\Block;
...
class Preorderproduct extends \Magento\Catalog\Block\Product\AbstractProduct {
	...
	public function getProducts()
    {
		...
		$products
			...
			->addAttributeToFilter('pre_order', 1);
	...
	{
		$path = 'preorderproduct/preorderproduct_config/' . $att;
